...
class TestRoom(unittest.TestCase):
    ...
    def setUp(self): # this happens before every single test you run
        self.song_1 = Song ("Kate Bush", "Hounds Of Love")
        playlist = [self.song_1]
        guests_in_room = []
        self.instance_of_room = Room ("The Bowie", 2, guests_in_room, playlist)
        self.instance_of_guest_1 = Guest ("Charlotte")
        self.instance_of_guest_2 = Guest ("Laura")
    ...
    def test_add_song_to_room (self):
        self.song_2 = Song ("Curtis Mayfield", "Move On Up")
        self.instance_of_room.add_song_to_playlist (self.song_2)
